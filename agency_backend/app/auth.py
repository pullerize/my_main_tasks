...
# Поддержка множественных схем хеширования для обратной совместимости
# bcrypt - для старых паролей из БД
# argon2 - предпочтительный для новых паролей
# pbkdf2_sha256 - запасной вариант
